...
//  - 4× RJ45 keystone (14.5×16mm, elevated for clip) - 2 front, 2 back
//  - 4× JST 2-pin female (7.6×5.9mm, long side horizontal)
//  - 3× USB PD trigger boards (22×12mm)
// ============================================================
cutoutsRight =
[
    // === RJ45 KEYSTONES - FRONT SIDE (2×) ===
    ...
    // === RJ45 KEYSTONES - BACK SIDE ===

    [182,                  // mirrored position (202 - 20)
     12,                   // vertical center raised for clip
     14.5, 16,             // width × height
     0,
     yappRectangle,
...
// ============================================================
//  CUTOUTS – Front WALL
//  Access hole: 25mm from back, 5mm from floor
// ============================================================
cutoutsBack =
[
    [127,                  // 25mm from the edge
     5,                    // 5mm from floor
     20,                   // width
     20,                   // height  
     0,
